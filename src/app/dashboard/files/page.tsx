...
import { deleteProject, listImages } from "./_operations";
...
export default function AdminProjectsListing() {
    ...
    return (
        <div key="admin-projects-listing">
                    ...
                    <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 xl:grid-cols-3 xl:gap-10">
                        ...
                        {error ? <div>Error loading files: {error}</div> :
                            ...
                            images.map((image) => {
                                return (
                                    <div key={image._id}>
                                        <Image src={image.url} alt="Cover" width={300} height={300} />
                                    </div>
                                )
                            })
            ...
            <Link href="/dashboard/files/new" className="flex w-full justify-center rounded bg-primary p-3 font-medium text-gray">
